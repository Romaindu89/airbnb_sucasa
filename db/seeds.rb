...
t1 = "Stylish Urban Retreat: Modern Apartment in the Heart of the City"
t2 = "Tranquil Oasis: Serene Apartment with Spectacular Views"
t3 = "Charming Vintage Hideaway: Cozy Apartment with Retro Vibes"
t4 = "Luxury Living: Elegant and Spacious Apartment with Upscale Amenities"
t5 = "Seaside Bliss: Beachfront Apartment with Panoramic Ocean Views"
t6 = "Rustic Charm: Quaint Countryside Apartment Surrounded by Nature"
t7 = "Cosmopolitan Haven: Chic Loft Apartment in a Vibrant Neighborhood"
t8 = "Historic Elegance: Stunning Apartment in a Renovated Heritage Building"
